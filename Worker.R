...
### AWS Credentials ### 
Sys.setenv(
  "AWS_ACCESS_KEY_ID" = "AKIA4ECRNXARZUTMCSET",
  "AWS_SECRET_ACCESS_KEY" = "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",
  "AWS_DEFAULT_REGION" = "us-east-1",
  "WR_API_TOKEN" = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1Ijoic3VwcG9ydCtzdXBlckB3YXRlcnJlcG9ydGVyLm9yZyJ9.axbJ7d4bwjn1idHmEBeN-e4BkGZJ43xv-_38l2Vev8ACxQU8tahWK1oWBI7wVn52nAljztTeeLIRHXrzZZ7gRO94Cw20CsTb5W8BxNJ0dF5O1SbqeCoTqZEuRNaYhjSpSP7kz344czlmgAPIPe0V1yfvM2bCrz42FdhsRujVqzS-ytOjD4gg10Cpjb1_yqo-Q0QeTv1NZ1olYs76x9DFzl1Ild8Da9gI65yLd5Eig484mX1ePrV5OmLjQHIGpxUvF4o8oFKuJ-IQEDwAJIzhrpvO6qriZC6d2nM9Q3mu1lL9b-vgnOPBFK50K5hjTDLEa6JL36jWe3HVda9ymMePtA",
  "MB_API_TOKEN" = "pk.eyJ1IjoicmRhd2VzMSIsImEiOiJ0OHNqNUFFIn0.KpaFJHMqmruQ9UFeg2ATeA"
)
